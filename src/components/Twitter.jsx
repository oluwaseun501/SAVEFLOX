...
const triggerDownload = async (
  ...
  return (
    <>
      ...
      <ServicesStrip currentPage="/twitter-downloader" />
  ...
  >
    ...
    {downloading !== "hd" && (
     ...
     <AdSlot slot="twitter-top" format="leaderboard"  />
      <WhyChoose />
      <AdSlot slot="twitter-middle" format="leaderboard"  />
      <HowItWorks />
      <CourseLinks
  platform="twitter"
  courses={coursesByPlatform.twitter}
/>
